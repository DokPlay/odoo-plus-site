...
export const uiText = {
  en: {
    ...
    "meta.description":
      "Free open-source addons, Pro roadmap and custom module development for Odoo 19 Community Edition.",
    ...
    "trust.independent": "Independent project",
  ...
  ru: {
    ...
    "meta.description":
      "Бесплатные open-source модули, Pro-roadmap и кастомная разработка для Odoo 19 Community Edition.",
    ...
    "trust.license": "LGPL-3",
    "trust.community": "Odoo 19 Community",
    "trust.independent": "Независимый проект",

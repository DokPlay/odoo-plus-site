...
export const uiText = {
  en: {
    ...
    "hero.proCta": "Explore Pro Roadmap",
    ...
    "trust.aria": "Project trust signals",
    "trust.github": "Free open-source modules",
    "trust.license": "LGPL-3",
    "trust.community": "Odoo 19 Community",
    "trust.independent": "Not affiliated with Odoo S.A.",
    "stats.aria": "Project numbers",
    "stats.free": "Free module cards",
    "stats.pro": "Pro roadmap cards",
    "stats.services": "Service paths",
    ...
    "featured.healthLinkAria": "Open Free modules in the catalog",
    "featured.healthAlt": "Module Health Checker interface preview",
    "featured.healthBadge": "Free",
    "featured.healthMeta": "Ready / Odoo 19.0 Community",
    ...
    "featured.healthCta": "Open Free modules",
    "featured.dashboardLinkAria": "Open Pro modules in the catalog",
    "featured.dashboardAlt": "Dashboard Pro analytics preview",
    "featured.dashboardBadge": "Pro Coming Soon",
    "featured.dashboardMeta": "Not released yet / Odoo 19.0 Community",
    "featured.dashboardTitle": "Dashboard Pro",
    "featured.dashboardText": "Sales, invoices, inventory and CRM dashboards planned as a paid Pro module.",
    "featured.dashboardCta": "Open Pro modules",
    "featured.serviceLinkAria": "Open custom setup services",
    "featured.serviceBadge": "Service",
    "featured.serviceMeta": "Available by request",
    ...
    "featured.serviceCta": "Open services",
    ...
    "services.reportTitle": "Custom reports",
    "services.reportText": "Sales, invoice, inventory and accounting reports.",
    "services.adaptationTitle": "Module adaptation",
    "services.adaptationText": "Safe changes for public modules in real databases.",
    "how.title": "How it works",
    "how.body": "A simple workflow for module review, custom development and support.",
    "how.reviewTitle": "Review",
    "how.reviewText": "Send your Odoo version, installed apps and the workflow that needs improvement.",
    "how.deliveryTitle": "Setup or development",
    "how.deliveryText": "You get a practical scope: setup, report, private module, migration review or adaptation.",
    "how.supportTitle": "Delivery and support",
    "how.supportText": "The result is delivered with clear notes, version focus and follow-up steps.",
    ...
    "footer.copyright": "Copyright 2026 DokPlay",
  ...
  ru: {
    ...
    "trust.aria": "Сигналы доверия к проекту",
    "trust.github": "Бесплатные open-source модули",
    "trust.license": "LGPL-3",
    "trust.community": "Odoo 19 Community",
    "trust.independent": "Не связано с Odoo S.A.",
    "stats.aria": "Цифры проекта",
    "stats.free": "карточек Free",
    "stats.pro": "карточек Pro",
    "stats.services": "сценариев услуг",
    ...
    "featured.healthLinkAria": "Открыть бесплатные модули в каталоге",
    "featured.healthAlt": "Превью интерфейса проверки модулей",
    "featured.healthBadge": "Бесплатно",
    "featured.healthMeta": "Готово / Odoo 19.0 Community",
    ...
    "featured.healthCta": "Открыть бесплатные",
    "featured.dashboardLinkAria": "Открыть Pro-модули в каталоге",
    "featured.dashboardAlt": "Превью аналитики Dashboard Pro",
    "featured.dashboardBadge": "Pro скоро",
    "featured.dashboardMeta": "Еще не выпущено / Odoo 19.0 Community",
    "featured.dashboardTitle": "Панель управления Pro",
    "featured.dashboardText": "Панели продаж, счетов, склада и CRM, запланированные как платный Pro-модуль.",
    "featured.dashboardCta": "Открыть Pro-модули",
    "featured.serviceLinkAria": "Открыть услуги кастомной настройки",
    "featured.serviceBadge": "Услуга",
    "featured.serviceMeta": "Доступно по запросу",
    ...
    "featured.serviceCta": "Открыть услуги",
    ...
    "services.reportTitle": "Кастомные отчеты",
    "services.reportText": "Отчеты по продажам, счетам, складу и бухгалтерии.",
    "services.adaptationTitle": "Адаптация модулей",
    "services.adaptationText": "Безопасные доработки публичных модулей под реальные базы.",
    "how.title": "Как это работает",
    "how.body": "Простой процесс для ревью модулей, кастомной разработки и поддержки.",
    "how.reviewTitle": "Анализ",
    "how.reviewText": "Пришлите версию Odoo, установленные приложения и процесс, который нужно улучшить.",
    "how.deliveryTitle": "Настройка или разработка",
    "how.deliveryText": "Вы получаете понятный объем работ: настройка, отчет, приватный модуль, проверка миграции или адаптация.",
    "how.supportTitle": "Передача и поддержка",
    "how.supportText": "Результат передается с понятными заметками, фокусом по версиям и дальнейшими шагами.",
